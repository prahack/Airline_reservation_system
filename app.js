...
const { getAdminPassenger } = require('./routes/viewpassenger');
...
const { getAdminBooking, AdminEditBookingPage, AdminEditBooking, AdminDeleteBooking } = require('./routes/viewbooking');
...
app.get ('/admin-viewpassenger', getAdminPassenger);
...
app.get ('/admin-viewbookings', getAdminBooking);
app.get('/edit-booking/:booking_ID', AdminEditBookingPage);
app.post('/edit-booking/:booking_ID', AdminEditBooking);
app.get('/delete-booking/:booking_ID', AdminDeleteBooking);
